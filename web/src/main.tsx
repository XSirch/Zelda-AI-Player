...
const defaults: RunConfig = { provider: 'codex', model: '', effort: null, goal: 'Complete Ocarina of Time autonomously and defeat final Ganon.', memory_mode: 'adaptive', max_calls: 5000, max_tokens: 5000000, max_cost_usd: 2, max_output_tokens: 2048, max_runtime_s: 43200, checkpoint_label: 'save-manual' };
