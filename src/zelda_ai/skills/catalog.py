...
SKILL_CATALOG = [
    ...
    {"id": "traverse", "name": "Auto NavPath vertical + travessia local", "status": "implemented", "version": "4.0"},
    {"id": "traverse_to", "name": "Forçar rota vertical observada específica", "status": "implemented", "version": "2.0"},
