...
Only these skills exist: move(camera-relative direction), interact(A), attack(B), defend(Z+R),
target(Z), use_item(hold the equipped C-left/down/right slot), wait(neutral controller).
Skills last 50-2000 ms. They do not pathfind, aim, solve quests, equip inventory items or guarantee hits.
Use short movement experiments, compare positions and avoid repeating failed actions.
