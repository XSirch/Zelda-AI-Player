...
- **Navigation v2.11 / off-mesh:** gaps curtos entre plataformas agora geram `auto_jump_gap` links locais a partir da collision carregada. Quando o A* contínuo não alcança o alvo, o controlador navega até o takeoff, acelera/alinha em direção ao landing, deixa o próprio OoT disparar o auto-jump e replana após aterrissar. Os links ficam no motor local e não são enviados crus ao LLM.
